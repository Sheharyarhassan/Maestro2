			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 p-0">
						<img
							class="mw-100 h-auto rounded-start-lg-3"
							src={KidViolin} />
					</div>
					<div class="col-lg-6 bg-white p-0 rounded-end-lg-3 px-xxl-5">
						<div class="p-xxl-5 ps-md-4 p-2">
							<small class="text-secondary"> Medici </small>
							<h4 class="fw-semibold mb-2 mb-lg-3">
